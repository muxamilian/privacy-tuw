...
\newacronym{arm}{ARM}{Adversarial Robustness Metric}
...
\begin{table}
\caption{Accuracy drop when \textbf{Left:} when replacing feature values with random data \textbf{Right:} Feature dropout}
