...
We implement a three-layer LSTM-based classifier of 512 neurons each. As the input features we use \begin{itemize*}
\item source port
...
\autoref{tab:performance_results} shows that our classifier achieves an accuracy that is similar previous work based on these datasets~\cite{meghdouri_analysis_2018}. However unlike these classifiers, our recurrent classifier has the advantage that it can detect attacks already before they are over.
...
Accuracy	&	0.991	&	0.997	&		&		\\
Precision	&	0.970	&	0.997	&		&		\\
Recall	&	0.978	&	0.991	&		&		\\
F1	&	0.974	&	0.994	&		&		\\
Youden	&	0.972	&	0.990	&		&		\\
